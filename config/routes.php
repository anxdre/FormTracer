...
return [
    ...
    */
    ...
    'web' => [
        ...
        \App\Http\Controllers\Admin\FormController::class,
        \App\Http\Controllers\Admin\QuestionController::class,

        //general
        \App\Http\Controllers\General\AnswerController::class,
        \App\Http\Controllers\General\FormController::class
    ],
    'api' => [
        /** @inject api **/
    ],
